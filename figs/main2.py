...
pdf_file = "insight.pdf"
pages = convert_from_path(pdf_file, dpi=200)  # Adjust dpi for quality

# Define durations
hold_duration = 40  # Frames each page stays before fading
...
# Save as GIF
frames[0].save("animated_fig2.gif", save_all=True, append_images=frames[1:], duration=100, loop=0)

print("GIF saved as 'animated_fig2.gif'")
